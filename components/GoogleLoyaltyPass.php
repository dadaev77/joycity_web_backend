...
class GoogleLoyaltyPass
{
  ...
  {
    $this->keyFilePath = getenv('GOOGLE_APPLICATION_CREDENTIALS') ?: Yii::$app->params['appPath'] . '/config/google_wallet_key.json';
  }
  // [END setup]
  ...
  public function auth()
  {
    ...
    $this->client->setApplicationName('TEBOIL');
   ...
   */
  public function createJwtSaveUrl(string $issuerId, string $classSuffix, string $userId, string $QR_value)
  {
    ...
    //print $serviceAccount['client_email'];exit;
    $claims = [
      'iss' => $serviceAccount['client_email'],
      'aud' => 'google',
      'origins' => ['https://loy.teboil-azs.ru/', 'https://stg-loy.teboil-azs.ru/'],
      'typ' => 'savetowallet',
      'payload' => [
        'loyaltyObjects' => [
          $loyaltyObject,
