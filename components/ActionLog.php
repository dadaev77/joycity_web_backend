...
class ActionLog
{
    ...
    private static function appendLog(string $message): void
    {
    ...
    {
        self::appendLog(self::renderMessage($message, 'primary'));
    }
    public static function error(mixed $message): void
    {
        self::appendLog(self::renderMessage($message, 'danger'));
    }
    ...
    {
        self::appendLog(self::renderMessage($message, 'warning'));
    }
    public static function debug(mixed $message): void
    {
        self::appendLog(self::renderMessage($message, 'secondary'));
    }
    public static function success(mixed $message): void
    {
        self::appendLog(self::renderMessage($message, 'success'));
    }
    public static function log(mixed $message): void
    {
        self::appendLog(self::renderMessage($message));
    }
