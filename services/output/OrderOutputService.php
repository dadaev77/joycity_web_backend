...
class OrderOutputService extends OutputService
{
    ...
    public static function getCollection(array $ids, $showDeleted = false, $imageSize = 'large'): array
    {
        ...
        return array_map(static function ($model) use ($imageSize) {
            ...
            \app\services\UserActionLogService::info('Convert buyer offer prices to user currency :138');
            if ($info['buyerOffer']) {
            ...
            \app\services\UserActionLogService::info('Calculate order prices in user currency :140');
